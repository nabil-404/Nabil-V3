...
\033[1;98m    ║✯ 𝖄𝖔𝖚𝖙𝖚𝖇𝖊 ☪ NABIL RAHMAN🔥          ║  
...
print  """
\033[1;97m************************************************
\033[1;96m~ NABIL VAU IS NOT RESPONSIBLE FOR MISS USE ~
\033[1;97m************************************************

\033[1;95m____─▄───────▄█▄───────▄─ NABIL 💓
\033[1;95m____▐█▌──▄──█████──▄──▐█▌RAHMAN 💓
\033[1;95m____─█──███▄▄███▄▄███──█─ 
\033[1;95m____░█░░█▄█▄█▀▒▀█▄█▄█░░█░ 
\033[1;95m____██▄▄█▄█▄█▒▒▒█▄█▄█▄▄██ 
"""
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        os.system('xdg-open https://www.youtcom/channel/UCs3FOuvp53p1VJ9If-fo5Ww')
...
def login():
	...
	try:
		...
		if 'checkpoint' in url:
			print("\n\033[1;96m[!] \x1b[1;91mAisa lagta hai apka account checkpoint par hai")
...
def pilih_super():
	...
	if peak =="":
		...
		os.system('clear')
		print logo
		print "\033[1;97m•◈•═══\033[1;91mNABIL-RAHMAN\033[1;97m═══•◈•"
		...
		print "\033[1;95m•◈•══════•◈\033[1;91mNABIL-RAHMAN\033[1;95m◈•══════•◈•"
		try:
	...
	print "   \033[1;92m◄══════════════════NABIL RAHMAN══════════════════►"

	jalan('          \033[1;91mNabil start cloning Wait...')
	print  "  \033[1;92m ◄══════════════════Ch══════════════════►" 
	...
	def main(arg):
		...
		try:
			...
			if 'access_token' in q:
				...
				z = json.loads(x.text)
				print '\x1b[1;94m[  ✓  ] \x1b[1;92mCH-Hack100%'											
				...
				oks.append(user+pass1)
				    ...
				    print '\x1b[1;94m[ ❥ ] \x1b[1;94mAsim-Checkpoint'
	...
	p.map(main, id)
	print "\033[1;95m•◈•▬ ▬ ▬•◈\033[1;91mNabil-Rahman\033[1;95m◈•▬ ▬ ▬•◈•"
	print "  \033[1;91m«---•◈•---Developed By NABIL-RAHMAN--•◈•---»" #Dev:Nabil
	print '\033[1;93m✅Process Has Been Completed Press➡ Ctrl+Z.↩ Next Type (python2 nabil.py)↩\033[1;97m....'
...
•\033[1;95m◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•.
: \033[1;91m .NABIL RAHMAN. \033[1;95m :
•\033[1;95m◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•.' 
                Facebook
              \033[1;91mM Nabil"""
